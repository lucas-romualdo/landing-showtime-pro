...
import francisImage from "@/assets/Francis Poloni LP PRO.jpg"; // Certifique-se que a imagem está no local correto
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-foreground/80 mb-8">
                                Atua desde 2018 no setor de integração
                fotovoltaica e consultoria em investimento onde assessorou tanto
                no lado do comprador (Buy-Side) quanto no lado do vendedor
                (Sell-Side), ajudando na tomada de decisões inteligentes e
                seguras.              {" "}
              </p>
                         {" "}
            </div>
